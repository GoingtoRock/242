...
public class newChess {
    ...
    */
    ...
    public static void playerMove(int playerColor) {
        ...
        //isNotCheck if player choose right color
         while (!valid)
         {

             // check whether it is draw
             if(MoveCheck.isStaleMate()){
            ...
            if (playerColor == White) {
                //isNotCheck if king is safe first
                if (!CheckCheck.isNotCheck(newChess.Board, isBlack)) {
                    System.out
            ...
            //isNotCheck if player chooses the right position
             try {
